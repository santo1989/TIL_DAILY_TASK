            ...
            <div class="row">
                <div class="col-12">
                                    ...
                                    @foreach ($hpd_timeEntry as $key => $hourlyProductionDashboardTimeEntry)
                                        <tr>
                                            <td id="action_tr">
                                                ...
                                                <form action="{{ route('time_entry.destroy', $hourlyProductionDashboardTimeEntry->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <div class="card-footer">
                        ...
                        <a class="btn btn-outline-primary" id="print_send_email"><i class="fas fa-envelope"></i>Email Report</a>
