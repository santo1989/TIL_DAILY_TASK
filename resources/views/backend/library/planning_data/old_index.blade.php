                        ...
                        <div class="card" style="overflow-x:auto;">
                            <div class="card-header">
                                ...
                                <a class="btn btn-outline-info my-1 mx-1 inline btn-lg"
                                    href={{ route('planning_data.index') }}>Today Data</a>
                                ...
                                <table id="datatablesSimple" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($planning_data as $key => $planning_data)
                                            <tr>
                                                <td>{{ ++$sl }}</td>
                                                <td>{{ \Carbon\Carbon::parse($planning_data->old_date)->format('d-M-Y') }}
                                                </td>
                                                <td> 
                                                        {{ $planning_data->old_floor }}{{ $planning_data->old_floor == 1 ? 'st' : ($planning_data->old_floor == 2 ? 'nd' : ($planning_data->old_floor == 3 ? 'rd' : 'th')) }}
                                                        Floor 
                                                </td>
                                                <th>{{ $planning_data->old_line }}</th>
                                                <th>{{ $planning_data->old_buyer }}</th> 
                                                <td>{{ $planning_data->old_style }}</td>
                                                <td>{{ $planning_data->old_item }}</td>
                                                <td> {{ $planning_data->old_smv }}</td>
                                                <td>{{ $planning_data->old_allocate_qty }}</td>
                                                <td>{{ \Carbon\Carbon::parse($planning_data->old_sewing_start_time)->format('d-M-Y') }}</td>
                                                <td>{{ \Carbon\Carbon::parse($planning_data->old_sewing_end_time)->format('d-M-Y') }}</td>
                                                <td>{{ $planning_data->old_required_man_power }}</td>
                                                <td>{{ $planning_data->old_average_working_our }}</td>
                                                <td>{{ $planning_data->old_expected_efficiency }}</td>
                                                <td>{{ $planning_data->old_remarks }}
                                                </td>
                                                <td> 
                                                    @can('QC-EDIT')
                                                    <!-- Edit Button -->
                                                    <a href="{{ route('planning_data_edit',['planning_data'=>$planning_data->id]) }}" class="btn btn-outline-info my-1 mx-1 inline btn-sm"> <i class="bi bi-pencil"></i> Edit </a>
                                                        <form id="deleteForm"
                                                            ...
                                                            <input type="hidden" name="old_floor"
                                                                value="{{ $planning_data->old_floor }}">
