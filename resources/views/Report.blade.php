...
<body>
    <div class="dashboard">
        <div class="header">
            <div class="company-info">
                ...
                <div>
                    ...
                    <div class="report-title">Daily Incident Report as on {{ \Carbon\Carbon::parse($reportDate)->format('d/m/Y') }}</div>
                </div>
            </div>
            <div class="controls">
            ...
            <div class="section">
                ...
                <div class="section-content">
                    <div class="floor-tabs">
                        ...
                        <div class="floor-tab {{ $loop->first ? 'active' : '' }}" data-floor="{{ $floor }}">
                            {{ $floor }}
                        </div>
                        @endforeach
                    </div>
                    ...
                    @foreach($floors as $floor)
                    <div class="floor-content {{ $loop->first ? 'active' : '' }}" data-floor="{{ $floor }}">
                        <div class="table-container">
                            <table>
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $analysis->join_date ? \Carbon\Carbon::parse($analysis->join_date)->format('Y-m-d') : '' }}</td>
                                        <td>{{ $analysis->last_p_date ? \Carbon\Carbon::parse($analysis->last_p_date)->format('Y-m-d') : '' }}</td>
                                        <td>{{ $analysis->line }}</td>
                                        <td>{{ $analysis->total_absent_days }}</td>
                                        <td>{{ $analysis->absent_reason }}</td>
                                        <td>{{ $analysis->come_back ? \Carbon\Carbon::parse($analysis->come_back)->format('d.m.y') : '' }}</td>
        ...
        <div class="footer">
            <p>Generated on {{ \Carbon\Carbon::now()->format('F d, Y H:i') }} | Tosrifa Industries Ltd. - Factory Operations Dashboard</p>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.floor-tab').forEach(tab => {
                tab.addEventListener('click', function() {
                    ...
                    document.querySelector(`.floor-content[data-floor="${floor}"]`).classList.add('active');
                });
            });
            ...
            document.getElementById('downloadBtn').addEventListener('click', function() {
                ...
                worksheet.addRow(['Daily Incident Report as on {{ \Carbon\Carbon::parse($reportDate)->format("d/m/Y") }}']);
                ...
                workbook.xlsx.writeBuffer().then(buffer => {
                    ...
                    saveAs(blob, `Tosrifa_Daily_Report_{{ \Carbon\Carbon::parse($reportDate)->format("Y_m_d") }}.xlsx`);
                });
            });
